...
## Project Structure
    ...
    ├── testapiautoconnecto_53652  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_53652`
...
2. Clone this repo and `cd testapiautoconnecto_53652`
